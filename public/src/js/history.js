document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadExpenses() {
    ...
    try {
      const res = await fetch(`https://finora-expense-tracker-system.onrender.com/api/expenses/all?userId=${userId}&month=${month}&year=${year}`);
  ...
  editForm.onsubmit = async (e) => {
    ...
    try {
      const res = await fetch(`https://finora-expense-tracker-system.onrender.com/api/expenses/${id}`, {
        method: "PUT",
